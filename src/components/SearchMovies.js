...
function SearchMovies(){
	const apiKey = '3f15489c'; // Intenta poner cualquier cosa antes para probar
	const [movies, setMovies] = useState([]);
	const [searchkey, setSearchkey] = useState('action');
	
	
	
	
	useEffect(()=>{
		fetch("http://www.omdbapi.com/?s=" + searchkey + "&apikey=" + apiKey)
						...
						<div className="col-12 col-md-6">
							...
							<form method="GET" onSubmit={submitForm}>
								<div className="form-group" >
									...
									<input type="text" className="form-control" ref={searchContent}/>
								</div>
